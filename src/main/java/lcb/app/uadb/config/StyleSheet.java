...
public class StyleSheet {
    ...
    public static final String DATATABLES = "layout/assets/plugins/datatables/css/dataTables.bootstrap4.min.css";
    public static final String DATATABLES_RESPONSIVE = "layout/assets/plugins/datatables/css/responsive.bootstrap4.min.css";
