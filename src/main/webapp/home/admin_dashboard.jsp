...
%>
<%! String pageTitle = "Bienvenue sur UADB"; %>
<%!
    String[] styles = new String[]{
            StyleSheet.CORE, StyleSheet.FONTICON, StyleSheet.DATATABLES, StyleSheet.DATATABLES_RESPONSIVE, StyleSheet.STYLE
    };
%>
<%!
    String[] scripts = new String[]{
            Script.CORE, Script.SCRIPT, Script.PROCESS, Script.LAYOUT_SETTING, Script.APEXCHARTS, Script.JQUERY_DATATABLES,
            Script.DATATABLES, Script.DATATABLES_RESPONSIVE, Script.RESPONSIVE_DATATABLES, Script.DASHBOARD
    };
%>
